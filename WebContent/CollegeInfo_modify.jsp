...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>成立日期:</td>
    <td width=70%><input type="text" readonly  id="collegeInfo.collegeBirthDate"  name="collegeInfo.collegeBirthDate" onclick="setDay(this);" value='<%=collegeInfo.getCollegeBirthDate() %>'/></td>
  </tr>
  ...
  <tr>
    <td width=30%>附加信息:</td>
    <td width=70%><input id="collegeInfo.collegeMemo" name="collegeInfo.collegeMemo" type="text" size="100" value='<%=collegeInfo.getCollegeMemo() %>'/></td>
  </tr>
